                                         ...
                                         const xt::xtensor<double, 2>& x)
{
  ...
  // kx = 0 and ky = 0 and kz = 0
  // p = 1
  { // scope
    auto p00 = xt::view(P, idx(0, 0, 0), xt::all(), idx(1, 0, 0));
    p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0)) + 1.0)
          * xt::view(P, idx(0, 0, 0), xt::all(), idx(0, 0, 0));
  }

  // p > 1
  for (std::size_t p = 2; p <= n; ++p)
  {
    auto p00 = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, 0, 0));
    double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
    p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0)) + 1.0)
              * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 1, 0, 0)) * a
          - f2 * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 2, 0, 0))
                * (a - 1.0);
  }

  for (std::size_t p = 0; p < n; ++p)
  {
    auto p10 = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, 1, 0));
    p10 = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, 0, 0))
          * ((1.0 + (x1 * 2.0 - 1.0)) * p
    ...
    for (std::size_t q = 1; q < n - p; ++q)
    {
      ...
      auto pq1 = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q + 1, 0));
      pq1 = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 0))
                * (f3 * aq + f4 * bq)
            - xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q - 1, 0)) * f5 * cq;
    }
  }
  ...
  for (std::size_t p = 0; p < n; ++p)
  {
    for (std::size_t q = 0; q < n - p; ++q)
    {
      auto pq = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 1));
      pq = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 0))
  ...
  for (std::size_t p = 0; p + 1 < n; ++p)
  {
    for (std::size_t q = 0; q + 1 < n - p; ++q)
    {
      for (std::size_t r = 1; r < n - p - q; ++r)
      {
        ...
        xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, r + 1))
            = xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, r))
                  * ((x2 * 2.0 - 1.0) * ar + br)
              - xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, r - 1)) * cr;
      }
    }
  }
  ...
  if (nderiv >= 1)
  {
    // p = 1
    { // scope
      auto p00 = xt::view(P, idx(0, 0, 1), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(0, 0, 1), xt::all(), idx(0, 0, 0))
            + xt::view(P, idx(0, 0, 0), xt::all(), idx(0, 0, 0));
    }
    // p > 1
    for (std::size_t p = 2; p <= n; ++p)
    {
      auto p00 = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, 0, 0));
      double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(0, 0, 1), xt::all(), idx(p - 1, 0, 0)) * a
            + a * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 1, 0, 0))
            - f2 * xt::view(P, idx(0, 0, 1), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0)
            - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                  * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0);
    }

    for (std::size_t p = 0; p < n; ++p)
    {
      auto p10 = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, 1, 0));
      p10 = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, 0, 0))
                * ((1.0 + (x1 * 2.0 - 1.0)) * p
                   + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
            + xt::view(P, idx(0, 0, 0), xt::all(), idx(p, 0, 0));

      for (std::size_t q = 1; q < n - p; ++q)
      {
        auto [aq, bq, cq] = jrc(2 * p + 1, q);
        auto pq1 = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q + 1, 0));
        pq1 = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, 0))
                  * (f3 * aq + f4 * bq)
              - xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q - 1, 0)) * f5 * cq
              + xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 0)) * (aq - bq)
              + (1.0 - (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q - 1, 0))
                    * cq;
      }
    }
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      for (std::size_t q = 0; q < n - p; ++q)
      {
        auto pq = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, 1));
        pq = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, 0))
                 * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
             + 2 * (2.0 + p + q)
                   * xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 0));
      }
    }
    ...
    for (std::size_t p = 0; p + 1 < n; ++p)
    {
      for (std::size_t q = 0; q + 1 < n - p; ++q)
      {
        ...
        {
          auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
          xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, r + 1))
              = xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, r))
                    * ((x2 * 2.0 - 1.0) * ar + br)
                - xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, r - 1)) * cr
                + 2 * ar * xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, r));
        }
      }
    }
  }
  ...
  for (std::size_t kz = 2; kz <= nderiv; ++kz)
  {
    // p = 1
    { // scope
      auto p00 = xt::view(P, idx(0, 0, kz), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(0, 0, kz), xt::all(), idx(0, 0, 0))
            + kz * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(0, 0, 0));
    }
    // p > 1
    for (std::size_t p = 2; p <= n; ++p)
    {
      auto p00 = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, 0, 0));
      double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(0, 0, kz), xt::all(), idx(p - 1, 0, 0)) * a
            + kz * a
                  * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p - 1, 0, 0))
            - f2 * xt::view(P, idx(0, 0, kz), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0)
            - kz * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                  * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0)
            - kz * (kz - 1)
                  * xt::view(P, idx(0, 0, kz - 2), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0);
    }

    for (std::size_t p = 0; p < n; ++p)
    {
      auto p10 = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, 1, 0));
      p10 = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, 0, 0))
                * ((1.0 + (x1 * 2.0 - 1.0)) * p
                   + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
            + kz * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p, 0, 0));

      for (std::size_t q = 1; q < n - p; ++q)
      {
        auto [aq, bq, cq] = jrc(2 * p + 1, q);
        auto pq1 = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q + 1, 0));
        pq1 = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, 0))
                  * (f3 * aq + f4 * bq)
              - xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q - 1, 0)) * f5
                    * cq
              + kz * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p, q, 0))
                    * (aq - bq)
              + kz * (1.0 - (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 0, kz - 1), xt::all(),
                               idx(p, q - 1, 0))
                    * cq
              - kz * (kz - 1)
                    * xt::view(P, idx(0, 0, kz - 2), xt::all(),
                               idx(p, q - 1, 0))
                    * cq;
      }
    }
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      for (std::size_t q = 0; q < n - p; ++q)
      {
        auto pq = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, 1));
        pq = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, 0))
                 * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
             + 2 * kz * (2.0 + p + q)
                   * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p, q, 0));
      }
    }
    ...
    for (std::size_t p = 0; p + 1 < n; ++p)
    {
      for (std::size_t q = 0; q + 1 < n - p; ++q)
      {
        ...
        {
          auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
          xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, r + 1))
              = xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, r))
                    * ((x2 * 2.0 - 1.0) * ar + br)
                - xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, r - 1)) * cr
                + 2 * kz * ar
                      * xt::view(P, idx(0, 0, kz - 1), xt::all(), idx(p, q, r));
        }
      }
    }
  }
  ...
  if (nderiv >= 1)
  {
    ...
    { // scope
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, 1, 0), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, 0), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(0, 0, 0), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, 0), xt::all(), idx(p - 1, 0, 0)) * a
              + a * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, 1, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0);
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * xt::view(P, idx(0, 0, 0), xt::all(), idx(p, 0, 0))
                    * (1.5 + p);

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * xt::view(P, idx(0, 0, 0), xt::all(), idx(p, q, 0)) * aq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, r - 1)) * cr;
          }
        }
      }
    }
    ...
    { // scope
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, 1, 1), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, 1), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(0, 0, 1), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(0, 1, 0), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, 1), xt::all(), idx(p - 1, 0, 0)) * a
              + a * xt::view(P, idx(0, 0, 1), xt::all(), idx(p - 1, 0, 0))
              + a * xt::view(P, idx(0, 1, 0), xt::all(), idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, 1, 1), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 0, 1), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 1, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - 2.0 * xt::view(P, idx(0, 0, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0);
      }

      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * xt::view(P, idx(0, 0, 1), xt::all(), idx(p, 0, 0))
                    * (1.5 + p)
              + xt::view(P, idx(0, 1, 0), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * xt::view(P, idx(0, 0, 1), xt::all(), idx(p, q, 0)) * aq
                + xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, 0)) * (aq - bq)
                + (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q - 1, 0))
                      * cq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, 0))
                   * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
               + 2 * (2.0 + p + q)
                     * xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, 0));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, 1, 1), xt::all(), idx(p, q, r - 1)) * cr
                  + 2 * ar * xt::view(P, idx(0, 1, 0), xt::all(), idx(p, q, r));
          }
        }
      }
    }
    ...
    for (std::size_t kz = 2; kz + 1 <= nderiv; ++kz)
    {
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, 1, kz), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, kz), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(0, 0, kz), xt::all(), idx(0, 0, 0))
              + kz * xt::view(P, idx(0, 1, kz - 1), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, 1, kz), xt::all(), idx(p - 1, 0, 0)) * a
              + a * xt::view(P, idx(0, 0, kz), xt::all(), idx(p - 1, 0, 0))
              + kz * a
                    * xt::view(P, idx(0, 1, kz - 1), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, 1, kz), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 0, kz), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - kz * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, 1, kz - 1), xt::all(),
                               idx(p - 2, 0, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * xt::view(P, idx(0, 0, kz), xt::all(), idx(p, 0, 0))
                    * (1.5 + p)
              + kz * xt::view(P, idx(0, 1, kz - 1), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * xt::view(P, idx(0, 0, kz), xt::all(), idx(p, q, 0)) * aq
                + kz * xt::view(P, idx(0, 1, kz - 1), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + kz * (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(0, 1, kz - 1), xt::all(),
                                 idx(p, q - 1, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, 0))
                   * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
               + 2 * kz * (2.0 + p + q)
                     * xt::view(P, idx(0, 1, kz - 1), xt::all(), idx(p, q, 0));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, 1, kz), xt::all(), idx(p, q, r - 1)) * cr
                  + 2 * kz * ar
                        * xt::view(P, idx(0, 1, kz - 1), xt::all(),
                                   idx(p, q, r));
          }
  ...
  // kx = 0 and 1 < ky < nderiv
  for (std::size_t ky = 2; ky <= nderiv; ++ky)
  {
    // kz = 0
    { // scope
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, ky, 0), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, ky, 0), xt::all(), idx(0, 0, 0))
              + ky * xt::view(P, idx(0, ky - 1, 0), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, ky, 0), xt::all(), idx(p - 1, 0, 0)) * a
              + ky * a
                    * xt::view(P, idx(0, ky - 1, 0), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, ky, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * ky * xt::view(P, idx(0, ky - 1, 0), xt::all(), idx(p, 0, 0))
                    * (1.5 + p);

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * ky
                      * xt::view(P, idx(0, ky - 1, 0), xt::all(), idx(p, q, 0))
                      * aq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, r - 1))
                        * cr;
          }
    ...
    // p = 1
    { // scope
      auto p00 = xt::view(P, idx(0, ky, 1), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(0, ky, 1), xt::all(), idx(0, 0, 0))
            + ky * xt::view(P, idx(0, ky - 1, 1), xt::all(), idx(0, 0, 0))
            + xt::view(P, idx(0, ky, 0), xt::all(), idx(0, 0, 0));
    }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, ky, 1), xt::all(), idx(p - 1, 0, 0)) * a
              + ky * a
                    * xt::view(P, idx(0, ky - 1, 1), xt::all(),
                               idx(p - 1, 0, 0))
              + a * xt::view(P, idx(0, ky, 0), xt::all(), idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, ky, 1), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ky * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, ky - 1, 1), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ky * (ky - 1)
                    * xt::view(P, idx(0, ky - 2, 1), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, ky, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - 2.0 * ky
                    * xt::view(P, idx(0, ky - 1, 0), xt::all(),
                               idx(p - 2, 0, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * ky * xt::view(P, idx(0, ky - 1, 1), xt::all(), idx(p, 0, 0))
                    * (1.5 + p)
              + xt::view(P, idx(0, ky, 0), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * ky
                      * xt::view(P, idx(0, ky - 1, 1), xt::all(), idx(p, q, 0))
                      * aq
                + xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q - 1, 0))
                      * cq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, 0))
                   * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
               + 2 * (2.0 + p + q)
                     * xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, 0));
        }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, ky, 1), xt::all(), idx(p, q, r - 1)) * cr
                  + 2 * ar
                        * xt::view(P, idx(0, ky, 0), xt::all(), idx(p, q, r));
          }
        }
    ...
    // kz > 1
    for (std::size_t kz = 2; kz <= nderiv - ky; ++kz)
    {
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, ky, kz), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, ky, kz), xt::all(), idx(0, 0, 0))
              + ky * xt::view(P, idx(0, ky - 1, kz), xt::all(), idx(0, 0, 0))
              + kz * xt::view(P, idx(0, ky, kz - 1), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, ky, kz), xt::all(), idx(p - 1, 0, 0)) * a
              + ky * a
                    * xt::view(P, idx(0, ky - 1, kz), xt::all(),
                               idx(p - 1, 0, 0))
              + kz * a
                    * xt::view(P, idx(0, ky, kz - 1), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, ky, kz), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ky * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, ky - 1, kz), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ky * (ky - 1)
                    * xt::view(P, idx(0, ky - 2, kz), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - kz * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, ky, kz - 1), xt::all(),
                    ...
                    * (a - 1.0)
              - kz * (kz - 1)
                    * xt::view(P, idx(0, ky, kz - 2), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - 2.0 * ky * kz
                    * xt::view(P, idx(0, ky - 1, kz - 1), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0);
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * ky
                    * xt::view(P, idx(0, ky - 1, kz), xt::all(), idx(p, 0, 0))
                    * (1.5 + p)
              + kz * xt::view(P, idx(0, ky, kz - 1), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * ky
                      * xt::view(P, idx(0, ky - 1, kz), xt::all(), idx(p, q, 0))
                      * aq
                + kz * xt::view(P, idx(0, ky, kz - 1), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + kz * (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(0, ky, kz - 1), xt::all(),
                                 idx(p, q - 1, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, 0))
                   * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
               + 2 * kz * (2.0 + p + q)
                     * xt::view(P, idx(0, ky, kz - 1), xt::all(), idx(p, q, 0));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, ky, kz), xt::all(), idx(p, q, r - 1))
                        * cr
                  + 2 * kz * ar
  ...
  if (nderiv >= 1)
  {
    ...
    { // scope
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, nderiv, 0), xt::all(), idx(0, 0, 0))
              + nderiv
                    * xt::view(P, idx(0, nderiv - 1, 0), xt::all(),
                               idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p - 1, 0, 0))
                  * a
              + nderiv * a
                    * xt::view(P, idx(0, nderiv - 1, 0), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - nderiv * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(0, nderiv - 1, 0), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - nderiv * (nderiv - 1)
                    * xt::view(P, idx(0, nderiv - 2, 0), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0);
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + 2 * nderiv
                    * xt::view(P, idx(0, nderiv - 1, 0), xt::all(),
        ...
        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1
              = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q - 1, 0))
                      * f5 * cq
                + 2 * nderiv
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(0, nderiv, 0), xt::all(), idx(p, q, r - 1))
                        * cr;
          }
  ...
  for (std::size_t kx = 1; kx + 1 < nderiv; ++kx)
  {
    ...
    // p = 1
    {
      auto p00 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(kx, 0, 0), xt::all(), idx(0, 0, 0))
            + 2 * kx * xt::view(P, idx(kx - 1, 0, 0), xt::all(), idx(0, 0, 0));
    }
    // p > 1
    for (std::size_t p = 2; p <= n; ++p)
    {
      auto p00 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, 0, 0));
      double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 1, 0, 0)) * a
            + 2 * kx * a
                  * xt::view(P, idx(kx - 1, 0, 0), xt::all(), idx(p - 1, 0, 0))
            - f2 * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0);
    }

    for (std::size_t p = 0; p < n; ++p)
    {
      auto p10 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, 1, 0));
      p10 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, 0, 0))
            * ((1.0 + (x1 * 2.0 - 1.0)) * p
               + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
      ...
      {
        auto [aq, bq, cq] = jrc(2 * p + 1, q);
        auto pq1 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q + 1, 0));
        pq1 = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 0))
                  * (f3 * aq + f4 * bq)
              - xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q - 1, 0)) * f5
                    * cq;
      }
    }
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      for (std::size_t q = 0; q < n - p; ++q)
      {
        auto pq = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 1));
        pq = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 0))
             * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
      }
    }
    ...
    for (std::size_t p = 0; p + 1 < n; ++p)
    {
      for (std::size_t q = 0; q + 1 < n - p; ++q)
      {
        ...
        {
          auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
          xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, r + 1))
              = xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, r))
                    * ((x2 * 2.0 - 1.0) * ar + br)
                - xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, r - 1)) * cr;
        }
      }
    }
    // ky = 0 and kz = 1
    { // scope
      ...
      for (std::size_t p = 1; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 0, 1), xt::all(), idx(0, 0, 0))
              + 2 * kx * xt::view(P, idx(kx - 1, 0, 1), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(kx, 0, 0), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 0, 1), xt::all(), idx(p - 1, 0, 0)) * a
              + 2 * kx * a
                    * xt::view(P, idx(kx - 1, 0, 1), xt::all(),
                               idx(p - 1, 0, 0))
              + a * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(kx, 0, 1), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0);
      }

      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q - 1, 0))
                      * cq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
          +2 * (2.0 + p + q)
              * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 0));
        }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(kx, 0, 1), xt::all(), idx(p, q, r - 1)) * cr
                  + 2 * ar
                        * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, r));
          }
        }
    ...
    // ky = 0 and kz > 1
    for (std::size_t kz = 2; kz <= nderiv - kx; ++kz)
    {
      // p = 1
      for (std::size_t p = 1; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 0, kz), xt::all(), idx(0, 0, 0))
              + 2 * kx
                    * xt::view(P, idx(kx - 1, 0, kz), xt::all(), idx(0, 0, 0))
              + kz * xt::view(P, idx(kx, 0, kz - 1), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 0, kz), xt::all(), idx(p - 1, 0, 0)) * a
              + 2 * kx * a
                    * xt::view(P, idx(kx - 1, 0, kz), xt::all(),
                               idx(p - 1, 0, 0))
              + kz * a
                    * xt::view(P, idx(kx, 0, kz - 1), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(kx, 0, kz), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - kz * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(kx, 0, kz - 1), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0)
              - kz * (kz - 1)
                    * xt::view(P, idx(kx, 0, kz - 2), xt::all(),
                               idx(p - 2, 0, 0))
                    * (a - 1.0);
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, 0, 0))
                  * ((1.0 + (x1 * 2.0 - 1.0)) * p
                     + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5)
              + kz * xt::view(P, idx(kx, 0, kz - 1), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + kz * xt::view(P, idx(kx, 0, kz - 1), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + kz * (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(kx, 0, kz - 1), xt::all(),
                                 idx(p, q - 1, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
          +2 * kz*(2.0 + p + q)
              * xt::view(P, idx(kx, 0, kz - 1), xt::all(), idx(p, q, 0));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, r - 1))
                        * cr
                  + 2 * kz * ar
    ...
    // p = 1
    { // scope
      auto p00 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(kx, 1, 0), xt::all(), idx(0, 0, 0))
            + 2 * kx * xt::view(P, idx(kx - 1, 1, 0), xt::all(), idx(0, 0, 0))
            + xt::view(P, idx(kx, 0, 0), xt::all(), idx(0, 0, 0));
    }
    // p > 1
    for (std::size_t p = 2; p <= n; ++p)
    {
      auto p00 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, 0, 0));
      double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(kx, 1, 0), xt::all(), idx(p - 1, 0, 0)) * a
            + 2 * kx * a
                  * xt::view(P, idx(kx - 1, 1, 0), xt::all(), idx(p - 1, 0, 0))
            + a * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 1, 0, 0))
            - f2 * xt::view(P, idx(kx, 1, 0), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0)
            - ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                  * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0);
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      auto p10 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, 1, 0));
      p10 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, 0, 0))
            * ((1.0 + (x1 * 2.0 - 1.0)) * p
               + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
      +2 * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, 0, 0)) * (1.5 + p);

      for (std::size_t q = 1; q < n - p; ++q)
      {
        auto [aq, bq, cq] = jrc(2 * p + 1, q);
        auto pq1 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q + 1, 0));
        pq1 = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, 0))
                  * (f3 * aq + f4 * bq)
              - xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q - 1, 0)) * f5
                    * cq
              + 2 * xt::view(P, idx(kx, 0, 0), xt::all(), idx(p, q, 0)) * aq;
      }
    }
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      for (std::size_t q = 0; q < n - p; ++q)
      {
        auto pq = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, 1));
        pq = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, 0))
             * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
      }
    }
    ...
    for (std::size_t p = 0; p + 1 < n; ++p)
    {
      for (std::size_t q = 0; q + 1 < n - p; ++q)
      {
        ...
        {
          auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
          xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, r + 1))
              = xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, r))
                    * ((x2 * 2.0 - 1.0) * ar + br)
                - xt::view(P, idx(kx, 1, 0), xt::all(), idx(p, q, r - 1)) * cr;
        }
      }
    }
    ...
    for (std::size_t kz = 2; kz + 1 <= nderiv - kx; ++kz)
    {
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 1, kz), xt::all(), idx(0, 0, 0))
              + 2 * kx
                    * xt::view(P, idx(kx - 1, 1, kz), xt::all(), idx(0, 0, 0))
              + xt::view(P, idx(kx, 0, kz), xt::all(), idx(0, 0, 0))
              + kz * xt::view(P, idx(kx, 1, kz - 1), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, 1, kz), xt::all(), idx(p - 1, 0, 0)) * a
              + 2 * kx * a
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, 0, 0))
              * ((1.0 + (x1 * 2.0 - 1.0)) * p
                 + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
        +2 * xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, 0, 0)) * (1.5 + p)
            + kz* xt::view(P, idx(kx, 1, kz - 1), xt::all(), idx(p, 0, 0));

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * xt::view(P, idx(kx, 0, kz), xt::all(), idx(p, q, 0)) * aq
                + kz * xt::view(P, idx(kx, 1, kz - 1), xt::all(), idx(p, q, 0))
                      * (aq - bq)
                + kz * (1.0 - (x2 * 2.0 - 1.0))
                      * xt::view(P, idx(kx, 1, kz - 1), xt::all(),
                                 idx(p, q - 1, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, 0))
                   * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q))
               + 2 * kz * (2.0 + p + q)
                     * xt::view(P, idx(kx, 1, kz - 1), xt::all(), idx(p, q, 0));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, r + 1))
                = xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, r))
                      * ((x2 * 2.0 - 1.0) * ar + br)
                  - xt::view(P, idx(kx, 1, kz), xt::all(), idx(p, q, r - 1))
                        * cr
                  + 2 * kz * ar
    ...
    // ky > 1
    for (std::size_t ky = 2; ky <= nderiv - kx; ++ky)
    {
      // kz = 0
      // p = 1
      { // scope
        auto p00 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(1, 0, 0));
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, ky, 0), xt::all(), idx(0, 0, 0))
              + 2 * kx
                    * xt::view(P, idx(kx - 1, ky, 0), xt::all(), idx(0, 0, 0))
              + ky * xt::view(P, idx(kx, ky - 1, 0), xt::all(), idx(0, 0, 0));
      }
      // p > 1
      for (std::size_t p = 2; p <= n; ++p)
      {
        auto p00 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, 0, 0));
        double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
        p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
               + 1.0)
                  * xt::view(P, idx(kx, ky, 0), xt::all(), idx(p - 1, 0, 0)) * a
              + 2 * kx * a
                    * xt::view(P, idx(kx - 1, ky, 0), xt::all(),
                               idx(p - 1, 0, 0))
              + ky * a
                    * xt::view(P, idx(kx, ky - 1, 0), xt::all(),
                               idx(p - 1, 0, 0))
              - f2 * xt::view(P, idx(kx, ky, 0), xt::all(), idx(p - 2, 0, 0))
                    * (a - 1.0)
              - ky * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                    * xt::view(P, idx(kx, ky - 1, 0), xt::all(),
                               idx(p - 2, 0, 0))
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        auto p10 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, 1, 0));
        p10 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, 0, 0))
              * ((1.0 + (x1 * 2.0 - 1.0)) * p
                 + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
        +2 * ky* xt::view(P, idx(kx, ky - 1, 0), xt::all(), idx(p, 0, 0))
            * (1.5 + p);

        for (std::size_t q = 1; q < n - p; ++q)
        {
          auto [aq, bq, cq] = jrc(2 * p + 1, q);
          auto pq1 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q + 1, 0));
          pq1 = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q, 0))
                    * (f3 * aq + f4 * bq)
                - xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q - 1, 0)) * f5
                      * cq
                + 2 * ky
                      * xt::view(P, idx(kx, ky - 1, 0), xt::all(), idx(p, q, 0))
                      * aq;
        }
      }
      ...
      for (std::size_t p = 0; p < n; ++p)
      {
        for (std::size_t q = 0; q < n - p; ++q)
        {
          auto pq = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q, 1));
          pq = xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q, 0))
               * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
        }
      }
      ...
      for (std::size_t p = 0; p + 1 < n; ++p)
      {
        for (std::size_t q = 0; q + 1 < n - p; ++q)
        {
          ...
          {
            auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
            xt::view(P, idx(kx, ky, 0), xt::all(), idx(p, q, r + 1))
      ...
      for (std::size_t kz = 2; kz <= nderiv - kx - ky; ++kz)
      {
        // p = 1
        { // scope
          auto p00 = xt::view(P, idx(kx, ky, kz), xt::all(), idx(1, 0, 0));
          p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                 + 1.0)
                    * xt::view(P, idx(kx, ky, kz), xt::all(), idx(0, 0, 0))
                + 2 * kx
                      * xt::view(P, idx(kx - 1, ky, kz), xt::all(),
                                 idx(0, 0, 0))
                + ky * xt::view(P, idx(kx, ky - 1, kz), xt::all(), idx(0, 0, 0))
                + kz
        ...
        for (std::size_t p = 2; p <= n; ++p)
        {
          ...
          p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
                 + 1.0)
                    * xt::view(P, idx(kx, ky, kz), xt::all(), idx(p - 1, 0, 0))
                    * a
                + 2 * kx * a
                      * xt::view(P, idx(kx - 1, ky, kz), xt::all(),
                                 idx(p - 1, 0, 0))
        ...
        for (std::size_t p = 0; p < n; ++p)
        {
          ...
          p10 = xt::view(P, idx(kx, ky, kz), xt::all(), idx(p, 0, 0))
                * ((1.0 + (x1 * 2.0 - 1.0)) * p
                   + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
          +2 * ky* xt::view(P, idx(kx, ky - 1, kz), xt::all(), idx(p, 0, 0))
                  * (1.5 + p)
              + kz* xt::view(P, idx(kx, ky, kz - 1), xt::all(), idx(p, 0, 0));
  ...
  if (nderiv >= 1)
  {
    ...
    // p = 1
    {
      auto p00 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(1, 0, 0));
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(0, 0, 0))
            + 2 * nderiv
                  * xt::view(P, idx(nderiv - 1, 0, 0), xt::all(), idx(0, 0, 0));
    }
    // p > 1
    for (std::size_t p = 2; p <= n; ++p)
    {
      auto p00 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, 0, 0));
      double a = static_cast<double>(2 * p - 1) / static_cast<double>(p);
      p00 = ((x0 * 2.0 - 1.0) + 0.5 * ((x1 * 2.0 - 1.0) + (x2 * 2.0 - 1.0))
             + 1.0)
                * xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p - 1, 0, 0))
                * a
            + 2 * nderiv * a
                  * xt::view(P, idx(nderiv - 1, 0, 0), xt::all(),
                             idx(p - 1, 0, 0))
            - f2 * xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p - 2, 0, 0))
                  * (a - 1.0);
    }

    for (std::size_t p = 0; p < n; ++p)
    {
      auto p10 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, 1, 0));
      p10 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, 0, 0))
            * ((1.0 + (x1 * 2.0 - 1.0)) * p
               + (2.0 + (x1 * 2.0 - 1.0) * 3.0 + (x2 * 2.0 - 1.0)) * 0.5);
      ...
      {
        auto [aq, bq, cq] = jrc(2 * p + 1, q);
        auto pq1 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q + 1, 0));
        pq1 = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, 0))
                  * (f3 * aq + f4 * bq)
              - xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q - 1, 0)) * f5
                    * cq;
      }
    }
    ...
    for (std::size_t p = 0; p < n; ++p)
    {
      for (std::size_t q = 0; q < n - p; ++q)
      {
        auto pq = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, 1));
        pq = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, 0))
             * ((1.0 + p + q) + (x2 * 2.0 - 1.0) * (2.0 + p + q));
      }
    }
    ...
    for (std::size_t p = 0; p + 1 < n; ++p)
    {
      for (std::size_t q = 0; q + 1 < n - p; ++q)
      {
        ...
        {
          auto [ar, br, cr] = jrc(2 * p + 2 * q + 2, r);
          xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, r + 1))
              = xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, r))
                    * ((x2 * 2.0 - 1.0) * ar + br)
                - xt::view(P, idx(nderiv, 0, 0), xt::all(), idx(p, q, r - 1))
                      * cr;
        }
