    ...
    for (std::size_t p = 0; p < P.extent(2); ++p)
    {
      if (x0[p] + x1[p] < 0.5)
      {
        ...
        if (nderiv >= 1)
        {
          ...
          P(idx(1, 0), 3, p) = 4.381780460041329;
          P(idx(1, 0), 4, p) = 12.402055838085435;
      ...
      else if (x0[p] > 0.5)
      {
        ...
        if (nderiv >= 1)
        {
          P(idx(1, 0), 3, p) = -8.763560920082657;
          P(idx(1, 0), 4, p) = 2.75601240846343;
      ...
      else if (x1[p] > 0.5)
      {
        ...
        if (nderiv >= 1)
        {
          P(idx(1, 0), 2, p) = 13.856406460551018;
          P(idx(1, 0), 4, p) = -13.78006204231715;
          P(idx(1, 0), 5, p) = -1.4525460784051258;
