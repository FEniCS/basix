    ...
    stdex::mdspan<const T, stdex::dextents<std::size_t, 2>> x)
{
  ...
  auto x0 = stdex::submdspan(x, stdex::full_extent, 0);
  auto x1 = stdex::submdspan(x, stdex::full_extent, 1);
  auto x2 = stdex::submdspan(x, stdex::full_extent, 1);
  ...
  else if (n == 1)
  {
    for (std::size_t p = 0; p < P.extent(2); ++p)
    {
      if (x0[p] + x1[p] + x2[p] < 0.5)
      {
        ...
        P(idx(0, 0), 4, p) = -6.0 + 12.0 * x2[p] + 12.0 * x1[p] + 36.0 * x0[p];
        P(idx(0, 0), 5, p) = 1.240912295748704 - 2.481824591497408 * x2[p]
                             - 2.481824591497408 * x1[p]
                             - 7.445473774492224 * x0[p];
        P(idx(0, 0), 6, p) = 1.0125449320253626 - 2.025089864050725 * x2[p]
                             - 2.025089864050725 * x1[p]
                             - 6.075269592152176 * x0[p];
        P(idx(0, 0), 7, p) = -3.983118799112058 + 7.966237598224116 * x2[p]
                             + 29.116000823776726 * x1[p]
                             + 2.748949569119737 * x0[p];
        P(idx(0, 0), 8, p) = -0.5961277990195041 + 1.1922555980390082 * x2[p]
                             + 3.4223295404850287 * x1[p]
                             + 1.3466928516710042 * x0[p];
        P(idx(0, 0), 9, p) = -4.543441112511214 + 34.74396144861517 * x2[p]
                             + 5.3452248382484875 * x1[p]
                             + 5.3452248382484875 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 3, p) = -43.81780460041329;
          P(idx(0, 0, 1), 4, p) = 12.0;
          P(idx(0, 0, 1), 5, p) = -2.481824591497408;
          P(idx(0, 0, 1), 6, p) = -2.025089864050725;
          P(idx(0, 0, 1), 7, p) = 7.966237598224116;
          P(idx(0, 0, 1), 8, p) = 1.1922555980390082;
          P(idx(0, 0, 1), 9, p) = 34.74396144861517;
          P(idx(0, 1, 0), 3, p) = -43.81780460041329;
          P(idx(0, 1, 0), 4, p) = 12.0;
          P(idx(0, 1, 0), 5, p) = -2.481824591497408;
          P(idx(0, 1, 0), 6, p) = -2.025089864050725;
          P(idx(0, 1, 0), 7, p) = 29.116000823776726;
          P(idx(0, 1, 0), 8, p) = 3.4223295404850287;
          P(idx(0, 1, 0), 9, p) = 5.3452248382484875;
          P(idx(1, 0, 0), 3, p) = -43.81780460041329;
          P(idx(1, 0, 0), 4, p) = 36.0;
          P(idx(1, 0, 0), 5, p) = -7.445473774492224;
          P(idx(1, 0, 0), 6, p) = -6.075269592152176;
          P(idx(1, 0, 0), 7, p) = 2.748949569119737;
          P(idx(1, 0, 0), 8, p) = 1.3466928516710042;
          P(idx(1, 0, 0), 9, p) = 5.3452248382484875;
        }
      }
      else if (x0[p] > 0.5)
      {
        P(idx(0, 0), 0, p) = 17.88854381999832 * x2[p];
        P(idx(0, 0), 2, p) = -5.962847939999439 * x2[p];
        P(idx(0, 0), 4, p)
            = 24.0 - 30.666666666666668 * x2[p] - 24.0 * x1[p] - 24.0 * x0[p];
        P(idx(0, 0), 5, p) = -27.872799258355503 + 2.10000542357473 * x2[p]
                             + 4.963649182994816 * x1[p]
                             + 50.78194933371619 * x0[p];
        P(idx(0, 0), 6, p) = 0.2649650289412164 + 0.4352996904034269 * x2[p]
                             + 28.97581852207159 * x1[p]
                             - 4.5801097859838835 * x0[p];
        P(idx(0, 0), 7, p) = -8.55344232659941 + 1.0548899102671203 * x2[p]
                             + 1.2523569870658917 * x1[p]
                             + 11.889596624094441 * x0[p];
        P(idx(0, 0), 8, p) = -0.299608272046072 - 3.854753850654617 * x2[p]
                             + 1.575259987046358 * x1[p]
                             + 0.7536537977241399 * x0[p];
        P(idx(0, 0), 9, p) = -4.543441112511214 + 8.017837257372731 * x1[p]
                             + 5.3452248382484875 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 0, p) = 17.88854381999832;
          P(idx(0, 0, 1), 2, p) = -5.962847939999439;
          P(idx(0, 0, 1), 4, p) = -30.666666666666668;
          P(idx(0, 0, 1), 5, p) = 2.10000542357473;
          P(idx(0, 0, 1), 6, p) = 0.4352996904034269;
          P(idx(0, 0, 1), 7, p) = 1.0548899102671203;
          P(idx(0, 0, 1), 8, p) = -3.854753850654617;
          P(idx(0, 1, 0), 4, p) = -24.0;
          P(idx(0, 1, 0), 5, p) = 4.963649182994816;
          P(idx(0, 1, 0), 6, p) = 28.97581852207159;
          P(idx(0, 1, 0), 7, p) = 1.2523569870658917;
          P(idx(0, 1, 0), 8, p) = 1.575259987046358;
          P(idx(0, 1, 0), 9, p) = 8.017837257372731;
          P(idx(1, 0, 0), 4, p) = -24.0;
          P(idx(1, 0, 0), 5, p) = 50.78194933371619;
          P(idx(1, 0, 0), 6, p) = -4.5801097859838835;
          P(idx(1, 0, 0), 7, p) = 11.889596624094441;
          P(idx(1, 0, 0), 8, p) = 0.7536537977241399;
          P(idx(1, 0, 0), 9, p) = 5.3452248382484875;
        }
      }
      else if (x1[p] > 0.5)
      {
        P(idx(0, 0), 1, p) = -21.908902300206645 + 43.81780460041329 * x1[p];
        P(idx(0, 0), 2, p) = 5.962847939999439 + 23.851391759997757 * x2[p]
                             - 11.925695879998878 * x1[p];
        P(idx(0, 0), 4, p) = 0.6666666666666666 + 2.6666666666666665 * x2[p]
                             - 1.3333333333333333 * x1[p];
        P(idx(0, 0), 5, p) = 0.2863643759420086 + 1.1454575037680343 * x2[p]
                             - 0.5727287518840172 * x1[p];
        P(idx(0, 0), 6, p) = 5.346615762563831 - 3.539175743714819 * x2[p]
                             - 10.693231525127661 * x1[p]
                             + 24.92563879397014 * x0[p];
        P(idx(0, 0), 7, p) = 24.297977366620742 - 25.741738844794213 * x2[p]
                             - 27.44619150768887 * x1[p]
                             - 25.114694267591098 * x0[p];
        P(idx(0, 0), 8, p) = 1.7760284167679525 - 8.006027228282667 * x2[p]
                             - 1.3219828910898848 * x1[p]
                             - 0.5003767017676667 * x0[p];
        P(idx(0, 0), 9, p) = -4.543441112511214 + 5.3452248382484875 * x1[p]
                             + 8.017837257372731 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 2, p) = 23.851391759997757;
          P(idx(0, 0, 1), 4, p) = 2.6666666666666665;
          P(idx(0, 0, 1), 5, p) = 1.1454575037680343;
          P(idx(0, 0, 1), 6, p) = -3.539175743714819;
          P(idx(0, 0, 1), 7, p) = -25.741738844794213;
          P(idx(0, 0, 1), 8, p) = -8.006027228282667;
          P(idx(0, 1, 0), 1, p) = 43.81780460041329;
          P(idx(0, 1, 0), 2, p) = -11.925695879998878;
          P(idx(0, 1, 0), 4, p) = -1.3333333333333333;
          P(idx(0, 1, 0), 5, p) = -0.5727287518840172;
          P(idx(0, 1, 0), 6, p) = -10.693231525127661;
          P(idx(0, 1, 0), 7, p) = -27.44619150768887;
          P(idx(0, 1, 0), 8, p) = -1.3219828910898848;
          P(idx(0, 1, 0), 9, p) = 5.3452248382484875;
          P(idx(1, 0, 0), 6, p) = 24.92563879397014;
          P(idx(1, 0, 0), 7, p) = -25.114694267591098;
          P(idx(1, 0, 0), 8, p) = -0.5003767017676667;
          P(idx(1, 0, 0), 9, p) = 8.017837257372731;
        }
      }
      else if (x2[p] > 0.5)
      {
        P(idx(0, 0), 0, p) = 17.88854381999832 * x0[p];
        P(idx(0, 0), 2, p)
            = 23.851391759997757 * x1[p] - 5.962847939999439 * x0[p];
        P(idx(0, 0), 4, p)
            = 2.6666666666666665 * x1[p] - 6.666666666666667 * x0[p];
        P(idx(0, 0), 5, p)
            = 1.1454575037680343 * x1[p] - 2.863643759420086 * x0[p];
        P(idx(0, 0), 6, p)
            = -3.539175743714819 * x1[p] - 3.6148800376980237 * x0[p];
        P(idx(0, 0), 7, p)
            = -4.591975619241603 * x1[p] - 4.162398118837258 * x0[p];
        P(idx(0, 0), 8, p) = -23.125434358855063 + 46.25086871771013 * x2[p]
                             - 5.775953285836646 * x1[p]
                             - 3.7003165970226215 * x0[p];
        P(idx(0, 0), 9, p) = 30.200520336103956 - 34.74396144861517 * x2[p]
                             - 29.398736610366683 * x1[p]
                             - 29.398736610366683 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 8, p) = 46.25086871771013;
          P(idx(0, 0, 1), 9, p) = -34.74396144861517;
          P(idx(0, 1, 0), 2, p) = 23.851391759997757;
          P(idx(0, 1, 0), 4, p) = 2.6666666666666665;
          P(idx(0, 1, 0), 5, p) = 1.1454575037680343;
          P(idx(0, 1, 0), 6, p) = -3.539175743714819;
          P(idx(0, 1, 0), 7, p) = -4.591975619241603;
          P(idx(0, 1, 0), 8, p) = -5.775953285836646;
          P(idx(0, 1, 0), 9, p) = -29.398736610366683;
          P(idx(1, 0, 0), 0, p) = 17.88854381999832;
          P(idx(1, 0, 0), 2, p) = -5.962847939999439;
          P(idx(1, 0, 0), 4, p) = -6.666666666666667;
          P(idx(1, 0, 0), 5, p) = -2.863643759420086;
          P(idx(1, 0, 0), 6, p) = -3.6148800376980237;
          P(idx(1, 0, 0), 7, p) = -4.162398118837258;
          P(idx(1, 0, 0), 8, p) = -3.7003165970226215;
          P(idx(1, 0, 0), 9, p) = -29.398736610366683;
        }
      }
      else if (x1[p] + x2[p] < 0.5 && x0[p] + x1[p] < 0.5)
      {
        P(idx(0, 0), 0, p) = -8.94427190999916 + 17.88854381999832 * x2[p]
                             + 17.88854381999832 * x1[p]
                             + 17.88854381999832 * x0[p];
        P(idx(0, 0), 2, p) = 2.9814239699997196 - 5.962847939999439 * x2[p]
                             - 5.962847939999439 * x1[p]
                             - 5.962847939999439 * x0[p];
        P(idx(0, 0), 4, p) = 15.333333333333334 - 30.666666666666668 * x2[p]
                             - 30.666666666666668 * x1[p]
                             - 6.666666666666667 * x0[p];
        P(idx(0, 0), 5, p) = -1.050002711787365 + 2.10000542357473 * x2[p]
                             + 2.10000542357473 * x1[p]
                             - 2.863643759420086 * x0[p];
        P(idx(0, 0), 6, p) = -0.21764984520171346 + 0.4352996904034269 * x2[p]
                             + 0.4352996904034269 * x1[p]
                             - 3.6148800376980237 * x0[p];
        P(idx(0, 0), 7, p) = -0.5274449551335602 + 1.0548899102671203 * x2[p]
                             + 22.20465313581973 * x1[p]
                             - 4.162398118837258 * x0[p];
        P(idx(0, 0), 8, p) = 1.9273769253273085 - 3.854753850654617 * x2[p]
                             - 1.6246799082085968 * x1[p]
                             - 3.7003165970226215 * x0[p];
        P(idx(0, 0), 9, p) = 12.828539611796371 - 29.398736610366683 * x1[p]
                             - 29.398736610366683 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 0, p) = 17.88854381999832;
          ...
          P(idx(0, 0, 1), 7, p) = 1.0548899102671203;
          P(idx(0, 0, 1), 8, p) = -3.854753850654617;
          P(idx(0, 1, 0), 0, p) = 17.88854381999832;
          P(idx(0, 1, 0), 2, p) = -5.962847939999439;
          P(idx(0, 1, 0), 4, p) = -30.666666666666668;
          P(idx(0, 1, 0), 5, p) = 2.10000542357473;
          P(idx(0, 1, 0), 6, p) = 0.4352996904034269;
          P(idx(0, 1, 0), 7, p) = 22.20465313581973;
          P(idx(0, 1, 0), 8, p) = -1.6246799082085968;
          P(idx(0, 1, 0), 9, p) = -29.398736610366683;
          P(idx(1, 0, 0), 0, p) = 17.88854381999832;
          P(idx(1, 0, 0), 2, p) = -5.962847939999439;
          P(idx(1, 0, 0), 4, p) = -6.666666666666667;
      ...
      else if (x1[p] + x2[p] < 0.5)
      {
        P(idx(0, 0), 0, p) = 17.88854381999832 * x2[p];
        P(idx(0, 0), 2, p) = -5.962847939999439 * x2[p];
        P(idx(0, 0), 4, p) = 12.0 - 30.666666666666668 * x2[p] - 24.0 * x1[p];
        P(idx(0, 0), 5, p) = -2.481824591497408 + 2.10000542357473 * x2[p]
                             + 4.963649182994816 * x1[p];
        P(idx(0, 0), 6, p) = -14.487909261035796 + 0.4352996904034269 * x2[p]
                             + 28.97581852207159 * x1[p]
                             + 24.92563879397014 * x0[p];
        P(idx(0, 0), 7, p) = 9.948703119243358 + 1.0548899102671203 * x2[p]
                             + 1.2523569870658917 * x1[p]
                             - 25.114694267591098 * x0[p];
        P(idx(0, 0), 8, p) = 0.3274069776998313 - 3.854753850654617 * x2[p]
                             + 1.575259987046358 * x1[p]
                             - 0.5003767017676667 * x0[p];
        P(idx(0, 0), 9, p) = -5.879747322073336 + 8.017837257372731 * x1[p]
                             + 8.017837257372731 * x0[p];
        if (nderiv >= 1)
        {
          P(idx(0, 0, 1), 0, p) = 17.88854381999832;
      ...
      {
        P(idx(0, 0), 0, p) = 8.94427190999916 - 17.88854381999832 * x1[p];
        P(idx(0, 0), 2, p) = -14.907119849998598 + 23.851391759997757 * x2[p]
                             + 29.814239699997195 * x1[p];
        P(idx(0, 0), 4, p) = -4.666666666666667 + 2.6666666666666665 * x2[p]
                             + 9.333333333333334 * x1[p];
        P(idx(0, 0), 5, p) = -2.00455063159406 + 1.1454575037680343 * x2[p]
                             + 4.00910126318812 * x1[p];
        P(idx(0, 0), 6, p) = -12.500671543976672 - 3.539175743714819 * x2[p]
                             + 25.001343087953344 * x1[p]
                             + 24.92563879397014 * x0[p];
        P(idx(0, 0), 7, p) = 23.347017496774026 - 25.741738844794213 * x2[p]
                             - 25.54427176799544 * x1[p]
                             - 25.114694267591098 * x0[p];
        P(idx(0, 0), 8, p) = 2.403043666513856 - 8.006027228282667 * x2[p]
                             - 2.576013390581691 * x1[p]
                             - 0.5003767017676667 * x0[p];
        P(idx(0, 0), 9, p) = -5.879747322073336 + 8.017837257372731 * x1[p]
                             + 8.017837257372731 * x0[p];
        if (nderiv >= 1)
        {
          ...
          P(idx(0, 0, 1), 8, p) = -8.006027228282667;
          P(idx(0, 1, 0), 0, p) = -17.88854381999832;
          P(idx(0, 1, 0), 2, p) = 29.814239699997195;
          P(idx(0, 1, 0), 4, p) = 9.333333333333334;
          P(idx(0, 1, 0), 5, p) = 4.00910126318812;
          P(idx(0, 1, 0), 6, p) = 25.001343087953344;
          P(idx(0, 1, 0), 7, p) = -25.54427176799544;
          P(idx(0, 1, 0), 8, p) = -2.576013390581691;
          P(idx(0, 1, 0), 9, p) = 8.017837257372731;
          P(idx(1, 0, 0), 6, p) = 24.92563879397014;
          P(idx(1, 0, 0), 7, p) = -25.114694267591098;
          P(idx(1, 0, 0), 8, p) = -0.5003767017676667;
      ...
      {
        P(idx(0, 0), 0, p) = 17.88854381999832 * x0[p];
        P(idx(0, 0), 2, p) = -11.925695879998878 + 23.851391759997757 * x2[p]
                             + 23.851391759997757 * x1[p]
                             - 5.962847939999439 * x0[p];
        P(idx(0, 0), 4, p) = -1.3333333333333333 + 2.6666666666666665 * x2[p]
                             + 2.6666666666666665 * x1[p]
                             - 6.666666666666667 * x0[p];
        P(idx(0, 0), 5, p) = -0.5727287518840172 + 1.1454575037680343 * x2[p]
                             + 1.1454575037680343 * x1[p]
                             - 2.863643759420086 * x0[p];
        P(idx(0, 0), 6, p) = 1.7695878718574094 - 3.539175743714819 * x2[p]
                             - 3.539175743714819 * x1[p]
                             - 3.6148800376980237 * x0[p];
        P(idx(0, 0), 7, p) = 12.870869422397107 - 25.741738844794213 * x2[p]
                             - 4.591975619241603 * x1[p]
                             - 4.162398118837258 * x0[p];
        P(idx(0, 0), 8, p) = 4.0030136141413335 - 8.006027228282667 * x2[p]
                             - 5.775953285836646 * x1[p]
                             - 3.7003165970226215 * x0[p];
        P(idx(0, 0), 9, p) = 12.828539611796371 - 29.398736610366683 * x1[p]
                             - 29.398736610366683 * x0[p];
