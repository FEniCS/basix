...
make_xiao_gimbutas_quadrature(cell::type celltype, int m)
{
  if (celltype == cell::type::triangle)
  {
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<12, 2>> x
          = {{0.21942998254978302, 0.21942998254978302},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<15, 2>> x
          = {{0.47319565368925104, 0.47319565368925104},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<16, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<19, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<25, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<28, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<33, 2>> x
          = {{0.27146250701492614, 0.27146250701492614},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<38, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<42, 2>> x
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<49, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<55, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<60, 2>> x
          = {{0.4171034443615992, 0.4171034443615992},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<67, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    {
      xt::xtensor_fixed<double, xt::xshape<79, 2>> x
          = {{0.3333333333333333, 0.3333333333333333},
    ...
    else if (m == 21)
    {
      ...
      xt::xtensor_fixed<double, xt::xshape<87, 2>> x
          = {{0.2989362353149826, 0.2989362353149826},
