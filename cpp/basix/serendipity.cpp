...
//   M[0] = std::vector<xt::xtensor<double, 3>>(vertex_count,
//                                              xt::eye<double>({1, 1}));
...
//   {
//     x[0][i]
//         = xt::reshape_view(xt::view(geometry, i, xt::all()),
//                            {static_cast<std::size_t>(1), geometry.shape(1)});
//   }
...
//   // xt::xtensor<double, 2> interpolation_points({vertex_count + num_pts,
//   // tdim}); xt::xtensor<double, 2> interpolation_matrix
//   //     = xt::zeros<double>({vertex_count + num_mat0, vertex_count +
//   //     num_mat1});
...
//   //            xt::range(vertex_count, vertex_count + num_pts_dim[0]),
//   //            xt::all())
//   //       = points_1d;
//   // }
...
//   //       xt::view(base_transformations, num_edges + 2 * face + 1, range,
//   //       range)
