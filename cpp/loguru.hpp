...
#error                                                                         \
    "You are defining LOGURU_CATCH_SIGABRT. his is for older versions of Loguru. You should now instead set the options passed to loguru::init"
#endif
...
#define CHECK_WITH_INFO_S(cond, info)                                          \
  ...
  ? (void)0                                                                    \
  : loguru::Voidify()                                                          \
          & loguru::AbortLogger("CHECK FAILED:  " info "  ", __FILE__,         \
                                __LINE__)
