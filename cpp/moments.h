...
/// Make integral moments of functions crosses with the normal
///
/// This will compute the integral of each function in the moment space crossed with the normal over
...
/// @param poly_deg The polynomial degree of the poly set that defines the space
/// @param q_deg The quadrature degree used for the integrals
Eigen::MatrixXd make_integral_moments_cross_normal(const FiniteElement& moment_space,
                                          const cell::type celltype,
                                          const int value_size,
                                          const int poly_deg, const int q_deg);

/// Make interpolation points and weights for integral moments of functions cross with the normal
///
/// These can only be used when the moment space is defined on facets of
/// the cell
///
...
/// @param poly_deg The polynomial degree of the poly set that defines the space
/// @param q_deg The quadrature degree used for the integrals
Eigen::MatrixXd make_integral_moments_cross_normal_interpolation(const FiniteElement& moment_space,
                                          const cell::type celltype,
                                          const int value_size,
                                          const int poly_deg, const int q_deg);
