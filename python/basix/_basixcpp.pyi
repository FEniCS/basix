...
class FiniteElement:
    ...
    def pre_apply_dof_transformation(
        self, arg0: npt.NDArray[np.float64], arg1: int, arg2: int) -> npt.NDArray[np.float64]: ...
    ...
    def base_transformations(self) -> npt.NDArray[np.float64]: ...
    def entity_transformations(self) -> dict: ...
    def get_tensor_product_representation(self) -> List[Tuple[List[FiniteElement], List[int]]]: ...

    def pull_back(self, arg0: npt.NDArray[np.float64], arg1: npt.NDArray[np.float64],
                  arg2: npt.NDArray[np.float64], arg3: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]: ...
    def push_forward(self, arg0: npt.NDArray[np.float64], arg1: npt.NDArray[np.float64],
                     arg2: npt.NDArray[np.float64], arg3: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]: ...

    def tabulate(self, arg0: int, arg1: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]: ...
    def __eq__(self, arg0: object) -> bool: ...
    @property
    def M(self) -> List[List[npt.NDArray[np.float64]]]: ...
    @property
    def cell_type(self) -> CellType: ...
    @property
    def polyset_type(self) -> PolysetType: ...
    @property
    def coefficient_matrix(self) -> npt.NDArray[np.float64]: ...
    @property
    def degree(self) -> int: ...
    @property
    def dim(self) -> int: ...
    ...
    @property
    def dual_matrix(self) -> npt.NDArray[np.float64]: ...
    @property
    ...
    @property
    def interpolation_matrix(self) -> npt.NDArray[np.float64]: ...
    @property
    ...
    @property
    def wcoeffs(self) -> npt.NDArray[np.float64]: ...
    @property
    def x(self) -> List[List[npt.NDArray[np.float64]]]: ...
...
def cell_facet_jacobians(arg0: CellType) -> npt.NDArray[np.float64]: ...
def cell_facet_normals(arg0: CellType) -> npt.NDArray[np.float64]: ...
def cell_facet_orientations(arg0: CellType) -> List[bool]: ...
def cell_facet_outward_normals(arg0: CellType) -> npt.NDArray[np.float64]: ...
def cell_facet_reference_volumes(arg0: CellType) -> npt.NDArray[np.float64]: ...
def cell_volume(arg0: CellType) -> float: ...
def sobolev_space_intersection(arg0: SobolevSpace, arg1: SobolevSpace) -> SobolevSpace: ...
def compute_interpolation_operator(arg0: FiniteElement, arg1: FiniteElement) -> npt.NDArray[np.float64]: ...
def create_custom_element(arg0: CellType, arg1: List[int], arg2: npt.NDArray[np.float64], arg3: List[List[npt.NDArray[np.float64]]],
                          arg4: List[List[npt.NDArray[np.float64]]], arg5: int, arg6: MapType, arg7: SobolevSpace, arg8: bool, arg9: int, arg10: int, arg11: PolysetType) -> FiniteElement: ...
...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int,
                   arg3: LagrangeVariant, arg4: bool) -> FiniteElement: ...
...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: LagrangeVariant,
                   arg4: DPCVariant, arg5: bool) -> FiniteElement: ...
...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int,
                   arg3: LagrangeVariant, arg4: DPCVariant) -> FiniteElement: ...


@overload
def create_lattice(arg0, arg1: int, arg2: LatticeType, arg3: bool) -> npt.NDArray[np.float64]: ...


@overload
def create_lattice(arg0, arg1: int, arg2: LatticeType, arg3: bool,
                   arg4: LatticeSimplexMethod) -> npt.NDArray[np.float64]: ...


def geometry(arg0) -> npt.NDArray[np.float64]: ...
@overload
...
def make_quadrature(arg0: QuadratureType, arg1: CellType, arg2: PolysetType,
                    arg3: int) -> Tuple[npt.NDArray[np.float64], npt.NDArray[np.float64]]: ...


def sub_entity_connectivity(arg0) -> List[List[List[List[int]]]]: ...
def sub_entity_geometry(arg0, arg1: int, arg2: int) -> npt.NDArray[np.float64]: ...


def tabulate_polynomial_set(arg0: CellType, arg1: int, arg2: int,
                            arg3: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]: ...
def tabulate_polynomials(arg0: PolynomialType, arg1: CellType, arg2: int,
                         arg3: npt.NDArray[np.float64]) -> npt.NDArray[np.float64]: ...
