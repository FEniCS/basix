...
class FiniteElement:
    ...
    def apply_dof_transformation(self, arg0: numpy.ndarray[numpy.float64], arg1: int, arg2: int) -> numpy.ndarray[numpy.float64]: ...
    def apply_dof_transformation_to_transpose(self, arg0: numpy.ndarray[numpy.float64], arg1: int, arg2: int) -> numpy.ndarray[numpy.float64]: ...
    def apply_inverse_transpose_dof_transformation(self, arg0: numpy.ndarray[numpy.float64], arg1: int, arg2: int) -> numpy.ndarray[numpy.float64]: ...
    def base_transformations(self) -> numpy.ndarray[numpy.float64]: ...
    def entity_transformations(self) -> dict: ...
    def get_tensor_product_representation(self) -> List[Tuple[List[FiniteElement],List[int]]]: ...
    def pull_back(self, arg0: numpy.ndarray[numpy.float64], arg1: numpy.ndarray[numpy.float64], arg2: numpy.ndarray[numpy.float64], arg3: numpy.ndarray[numpy.float64]) -> numpy.ndarray[numpy.float64]: ...
    def push_forward(self, arg0: numpy.ndarray[numpy.float64], arg1: numpy.ndarray[numpy.float64], arg2: numpy.ndarray[numpy.float64], arg3: numpy.ndarray[numpy.float64]) -> numpy.ndarray[numpy.float64]: ...
    def tabulate(self, arg0: int, arg1: numpy.ndarray[numpy.float64]) -> numpy.ndarray[numpy.float64]: ...
    def __eq__(self, arg0: FiniteElement) -> bool: ...
    @property
    def M(self) -> List[List[numpy.ndarray[numpy.float64]]]: ...
    @property
    def cell_type(self) -> CellType: ...
    @property
    def coefficient_matrix(self) -> numpy.ndarray[numpy.float64]: ...
    @property
    def degree(self) -> int: ...
    @property
    def dim(self) -> int: ...
    ...
    @property
    def dual_matrix(self) -> numpy.ndarray[numpy.float64]: ...
    @property
    ...
    @property
    def interpolation_matrix(self) -> numpy.ndarray[numpy.float64]: ...
    @property
    ...
    @property
    def wcoeffs(self) -> numpy.ndarray[numpy.float64]: ...
    @property
    def x(self) -> List[List[numpy.ndarray[numpy.float64]]]: ...
...
def cell_facet_jacobians(arg0: CellType) -> numpy.ndarray[numpy.float64]: ...
def cell_facet_normals(arg0: CellType) -> numpy.ndarray[numpy.float64]: ...
def cell_facet_orientations(arg0: CellType) -> List[bool]: ...
def cell_facet_outward_normals(arg0: CellType) -> numpy.ndarray[numpy.float64]: ...
def cell_facet_reference_volumes(arg0: CellType) -> numpy.ndarray[numpy.float64]: ...
def cell_volume(arg0: CellType) -> float: ...
def compute_interpolation_operator(arg0: FiniteElement, arg1: FiniteElement) -> numpy.ndarray[numpy.float64]: ...
def create_custom_element(arg0: CellType, arg1: List[int], arg2: numpy.ndarray[numpy.float64], arg3: List[List[numpy.ndarray[numpy.float64]]], arg4: List[List[numpy.ndarray[numpy.float64]]], arg5: int, arg6: MapType, arg7: bool, arg8: int, arg9: int) -> FiniteElement: ...
@overload
...
@overload
def create_lattice(arg0, arg1: int, arg2: LatticeType, arg3: bool) -> numpy.ndarray[numpy.float64]: ...
@overload
def create_lattice(arg0, arg1: int, arg2: LatticeType, arg3: bool, arg4: LatticeSimplexMethod) -> numpy.ndarray[numpy.float64]: ...
def geometry(arg0) -> numpy.ndarray[numpy.float64]: ...
@overload
...
@overload
def make_quadrature(arg0: QuadratureType, arg1: CellType, arg2: int) -> Tuple[numpy.ndarray[numpy.float64],numpy.ndarray[numpy.float64]]: ...
@overload
def make_quadrature(arg0: CellType, arg1: int) -> Tuple[numpy.ndarray[numpy.float64],numpy.ndarray[numpy.float64]]: ...
def sub_entity_connectivity(arg0) -> List[List[List[List[int]]]]: ...
def sub_entity_geometry(arg0, arg1: int, arg2: int) -> numpy.ndarray[numpy.float64]: ...
def tabulate_polynomial_set(arg0: CellType, arg1: int, arg2: int, arg3: numpy.ndarray[numpy.float64]) -> numpy.ndarray[numpy.float64]: ...
def tabulate_polynomials(arg0: PolynomialType, arg1, arg2: int, arg3: numpy.ndarray[numpy.float64]) -> numpy.ndarray[numpy.float64]: ...
@overload
