...
class FiniteElement_float32:
    ...
    def pre_apply_dof_transformation(self, arg0: npt.NDArray[numpy.float32], arg1: int, arg2: int) -> npt.NDArray[numpy.float32]: ...
    def post_apply_transpose_dof_transformation(self, arg0: npt.NDArray[numpy.float32], arg1: int, arg2: int) -> npt.NDArray[numpy.float32]: ...
    def pre_apply_inverse_transpose_dof_transformation(self, arg0: npt.NDArray[numpy.float32], arg1: int, arg2: int) -> npt.NDArray[numpy.float32]: ...
    def base_transformations(self) -> npt.NDArray[numpy.float32]: ...
    def entity_transformations(self) -> dict: ...
    def get_tensor_product_representation(self) -> List[Tuple[List[FiniteElement_float32],List[int]]]: ...
    def pull_back(self, arg0: npt.NDArray[numpy.float32], arg1: npt.NDArray[numpy.float32], arg2: npt.NDArray[numpy.float32], arg3: npt.NDArray[numpy.float32]) -> npt.NDArray[numpy.float32]: ...
    def push_forward(self, arg0: npt.NDArray[numpy.float32], arg1: npt.NDArray[numpy.float32], arg2: npt.NDArray[numpy.float32], arg3: npt.NDArray[numpy.float32]) -> npt.NDArray[numpy.float32]: ...
    def tabulate(self, arg0: int, arg1: npt.NDArray[numpy.float32]) -> npt.NDArray[numpy.float32]: ...
    def __eq__(self, arg0: object) -> bool: ...
    @property
    def M(self) -> List[List[npt.NDArray[numpy.float32]]]: ...
    @property
    def cell_type(self) -> CellType: ...
    @property
    def polyset_type(self) -> PolysetType: ...
    @property
    def coefficient_matrix(self) -> npt.NDArray[numpy.float32]: ...
    @property
    def degree(self) -> int: ...
    @property
    def dim(self) -> int: ...
    ...
    @property
    def dual_matrix(self) -> npt.NDArray[numpy.float32]: ...
    @property
    ...
    @property
    def interpolation_matrix(self) -> npt.NDArray[numpy.float32]: ...
    @property
    ...
    @property
    def points(self) -> npt.NDArray[numpy.float32]: ...
    @property
    def value_shape(self) -> List[int]: ...
    @property
    def value_size(self) -> int: ...
    @property
    def wcoeffs(self) -> npt.NDArray[numpy.float32]: ...
    @property
    def x(self) -> List[List[npt.NDArray[numpy.float32]]]: ...

class FiniteElement_float64:
    def __hash__(self, object, int): ClassVar[None] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def pre_apply_dof_transformation(self, arg0: npt.NDArray[numpy.float64], arg1: int, arg2: int) -> npt.NDArray[numpy.float64]: ...
    def post_apply_transpose_dof_transformation(self, arg0: npt.NDArray[numpy.float64], arg1: int, arg2: int) -> npt.NDArray[numpy.float64]: ...
    def pre_apply_inverse_transpose_dof_transformation(self, arg0: npt.NDArray[numpy.float64], arg1: int, arg2: int) -> npt.NDArray[numpy.float64]: ...
    def base_transformations(self) -> npt.NDArray[numpy.float64]: ...
    def entity_transformations(self) -> dict: ...
    def get_tensor_product_representation(self) -> List[Tuple[List[FiniteElement_float64],List[int]]]: ...
...
def compute_interpolation_operator(arg0: FiniteElement_float64, arg1: FiniteElement_float64) -> npt.NDArray[numpy.float64]: ...
def create_custom_element(arg0: CellType, arg1: List[int], arg2: npt.NDArray[numpy.float64], arg3: List[List[npt.NDArray[numpy.float64]]], arg4: List[List[npt.NDArray[numpy.float64]]], arg5: int, arg6: MapType, arg7: SobolevSpace, arg8: bool, arg9: int, arg10: int, arg11: PolysetType) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: bool) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: LagrangeVariant, arg4: bool) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: DPCVariant, arg4: bool) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: LagrangeVariant, arg4: DPCVariant, arg5: bool) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: LagrangeVariant) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: DPCVariant) -> FiniteElement_float64: ...
@overload
def create_element(arg0: ElementFamily, arg1: CellType, arg2: int, arg3: LagrangeVariant, arg4: DPCVariant) -> FiniteElement_float64: ...
@overload
