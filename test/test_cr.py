...
def test_rannacher_turek_hexahedron():
    ...
    expected_table = np.array(
        [
            [
                [
                    [-2*p[0]**2/3 + 2*p[0]/3 - 2*p[1]**2/3 + 2*p[1]/3 + 4*p[2]**2/3 - 7*p[2]/3 + 2/3],
                    [-2*p[0]**2/3 + 2*p[0]/3 + 4*p[1]**2/3 - 7*p[1]/3 - 2*p[2]**2/3 + 2*p[2]/3 + 2/3],
                    [4*p[0]**2/3 - 7*p[0]/3 - 2*p[1]**2/3 + 2*p[1]/3 - 2*p[2]**2/3 + 2*p[2]/3 + 2/3],
                    [4*p[0]**2/3 - p[0]/3 - 2*p[1]**2/3 + 2*p[1]/3 - 2*p[2]**2/3 + 2*p[2]/3 - 1/3],
                    [-2*p[0]**2/3 + 2*p[0]/3 + 4*p[1]**2/3 - p[1]/3 - 2*p[2]**2/3 + 2*p[2]/3 - 1/3],
                    [-2*p[0]**2/3 + 2*p[0]/3 - 2*p[1]**2/3 + 2*p[1]/3 + 4*p[2]**2/3 - p[2]/3 - 1/3],
                ]
                for p in pts
            ]
        ]
