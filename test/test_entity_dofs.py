...
def test_number_of_dofs(cell_type, degree, element_type, element_kwargs):
...
@parametrize_over_elements(4)
def test_degreeing_of_dofs(cell_type, degree, element_type, element_kwargs):
    """
...
@parametrize_over_elements(4)
def test_closure_dofs(cell_type, degree, element_type, element_kwargs):
    element = basix.create_element(element_type, cell_type, degree, **element_kwargs)
