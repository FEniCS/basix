...
def sympy_nedelec(celltype, n):
    ...
    if celltype == basix.CellType.triangle:
        ...
        if n == 3:
            return [
                ...
                [
                    -45 * x**2 * y / 4 - 45 * x * y**2 + 45 * x * y / 2 - 45 * y**3 / 4 + 75 * y**2 / 4 - 6 * y,
                    45 * x**3 / 4 + 45 * x**2 * y - 75 * x**2 / 4 + 45 * x * y**2 / 4 - 45 * x * y / 2 + 6 * x,
                ],
                [
                ...
                [
                    45 * x**2 * y / 4 - 45 * x * y**2 / 2 - 45 * y**3 / 2 + 105 * y**2 / 4 - 21 * y / 4,
                    -45 * x**3 / 4
                    + 45 * x**2 * y / 2
                    + 15 * x**2
                    + 45 * x * y**2 / 2
                ...
                [
                    ...
                    - 9 * y / 4
                    - 3 / 2,
                    -45 * x**3 / 2 - 45 * x**2 * y / 2 + 105 * x**2 / 4 + 45 * x * y**2 / 4 - 21 * x / 4,
                ],
                [
                    90 * x**2 * y + 360 * x * y**2 - 300 * x * y + 270 * y**3 - 450 * y**2 + 180 * y,
                    -90 * x**3 - 360 * x**2 * y + 150 * x**2 - 270 * x * y**2 + 300 * x * y - 60 * x,
                ],
                [
                    -270 * x**2 * y - 360 * x * y**2 + 300 * x * y - 90 * y**3 + 150 * y**2 - 60 * y,
                    270 * x**3 + 360 * x**2 * y - 450 * x**2 + 90 * x * y**2 - 300 * x * y + 180 * x,
                ],
                [
    ...
    if celltype == basix.CellType.tetrahedron:
        if n == 1:
            return [[0, -z, y], [-z, 0, x], [-y, x, 0], [z, z, -x - y + 1], [y, -x - z + 1, y], [-y - z + 1, x, x]]
        if n == 2:
            return [
                ...
                [
                    8 * x * y + 8 * x * z - 6 * x + 8 * y**2 + 16 * y * z - 12 * y + 8 * z**2 - 12 * z + 4,
        ...
        if n == 3:
            return [
                ...
                [
                    0,
                    -45 * y**2 * z / 4 - 45 * y * z**2 + 45 * y * z / 2 - 45 * z**3 / 4 + 75 * z**2 / 4 - 6 * z,
                    45 * y**3 / 4 + 45 * y**2 * z - 75 * y**2 / 4 + 45 * y * z**2 / 4 - 45 * y * z / 2 + 6 * y,
                ],
                [-45 * x**2 * z + 30 * x * z - 3 * z, 0, 45 * x**3 - 45 * x**2 + 9 * x],
                [-45 * z**3 + 45 * z**2 - 9 * z, 0, 45 * x * z**2 - 30 * x * z + 3 * x],
                [
                    -45 * x**2 * z / 4 - 45 * x * z**2 + 45 * x * z / 2 - 45 * z**3 / 4 + 75 * z**2 / 4 - 6 * z,
                    0,
                    45 * x**3 / 4 + 45 * x**2 * z - 75 * x**2 / 4 + 45 * x * z**2 / 4 - 45 * x * z / 2 + 6 * x,
                ],
                ...
                [
                    45 * z**3 - 45 * z**2 + 9 * z,
                    45 * z**3 - 45 * z**2 + 9 * z,
                    -45 * x * z**2 + 30 * x * z - 3 * x - 45 * y * z**2 + 30 * y * z - 3 * y + 30 * z**2 - 24 * z + 3,
                ],
                [
                    45 * x**2 * z / 4
                    + 45 * x * y * z / 2
                ...
                [
                    45 * y**3 - 45 * y**2 + 9 * y,
                    -45 * x * y**2 + 30 * x * y - 3 * x - 45 * y**2 * z + 30 * y**2 + 30 * y * z - 24 * y - 3 * z + 3,
                    45 * y**3 - 45 * y**2 + 9 * y,
                ],
                [
                    45 * x**2 * y / 4
                ...
                [
                    -45 * x**2 * y - 45 * x**2 * z + 30 * x**2 + 30 * x * y + 30 * x * z - 24 * x - 3 * y - 3 * z + 3,
                    45 * x**3 - 45 * x**2 + 9 * x,
                    45 * x**3 - 45 * x**2 + 9 * x,
                ],
                [
                ...
                [
                    -180 * x * y * z - 180 * y**2 * z - 180 * y * z**2 + 150 * y * z,
                    270 * x**2 * z
                    + 360 * x * y * z
                    + 540 * x * z**2
                    - 450 * x * z
                ...
                [
                    180 * y**2 * z - 60 * y * z,
                    -360 * x * y * z + 60 * x * z - 180 * y**2 * z - 360 * y * z**2 + 360 * y * z + 60 * z**2 - 60 * z,
                    180 * x * y**2 - 60 * x * y + 180 * y**3 + 360 * y**2 * z - 240 * y**2 - 120 * y * z + 60 * y,
                ],
                [
                    90 * y**2 * z - 30 * y * z,
                    180 * x * y * z - 30 * x * z + 270 * y**2 * z + 180 * y * z**2 - 240 * y * z - 30 * z**2 + 30 * z,
                    -270 * x * y**2 + 90 * x * y - 270 * y**3 - 180 * y**2 * z + 360 * y**2 + 60 * y * z - 90 * y,
                ],
                [
                    90 * y * z**2 - 30 * y * z,
                    -270 * x * z**2 + 90 * x * z - 180 * y * z**2 + 60 * y * z - 270 * z**3 + 360 * z**2 - 90 * z,
                    180 * x * y * z - 30 * x * y + 180 * y**2 * z - 30 * y**2 + 270 * y * z**2 - 240 * y * z + 30 * y,
                ],
                [
                    180 * y * z**2 - 60 * y * z,
                    180 * x * z**2 - 60 * x * z + 360 * y * z**2 - 120 * y * z + 180 * z**3 - 240 * z**2 + 60 * z,
                    -360 * x * y * z + 60 * x * y - 360 * y**2 * z + 60 * y**2 - 180 * y * z**2 + 360 * y * z - 60 * y,
                ],
                [
                    90 * x**2 * z
                    + 360 * x * y * z
                    ...
                    - 450 * z**2
                    + 180 * z,
                    -180 * x**2 * z - 180 * x * y * z - 180 * x * z**2 + 150 * x * z,
                    -90 * x**3
                    - 180 * x**2 * y
                    - 360 * x**2 * z
                    + 150 * x**2
                ...
                [
                    -180 * x**2 * z - 360 * x * y * z - 360 * x * z**2 + 360 * x * z + 60 * y * z + 60 * z**2 - 60 * z,
                    180 * x**2 * z - 60 * x * z,
                    180 * x**3 + 180 * x**2 * y + 360 * x**2 * z - 240 * x**2 - 60 * x * y - 120 * x * z + 60 * x,
                ],
                [
                    270 * x**2 * z + 180 * x * y * z + 180 * x * z**2 - 240 * x * z - 30 * y * z - 30 * z**2 + 30 * z,
                    90 * x**2 * z - 30 * x * z,
                    -270 * x**3 - 270 * x**2 * y - 180 * x**2 * z + 360 * x**2 + 90 * x * y + 60 * x * z - 90 * x,
                ],
                [
                    -180 * x * z**2 + 60 * x * z - 270 * y * z**2 + 90 * y * z - 270 * z**3 + 360 * z**2 - 90 * z,
                    90 * x * z**2 - 30 * x * z,
                    180 * x**2 * z - 30 * x**2 + 180 * x * y * z - 30 * x * y + 270 * x * z**2 - 240 * x * z + 30 * x,
                ],
                [
                    360 * x * z**2 - 120 * x * z + 180 * y * z**2 - 60 * y * z + 180 * z**3 - 240 * z**2 + 60 * z,
                    180 * x * z**2 - 60 * x * z,
                    -360 * x**2 * z + 60 * x**2 - 360 * x * y * z + 60 * x * y - 180 * x * z**2 + 360 * x * z - 60 * x,
                ],
                [
                    90 * x**2 * y
                    + 360 * x * y**2
                    ...
                    + 150 * x * z
                    - 60 * x,
                    -180 * x**2 * y - 180 * x * y**2 - 180 * x * y * z + 150 * x * y,
                ],
                [
                    -270 * x**2 * y
                    - 360 * x * y**2
                ...
                [
                    -180 * x**2 * y - 360 * x * y**2 - 360 * x * y * z + 360 * x * y + 60 * y**2 + 60 * y * z - 60 * y,
                    180 * x**3 + 360 * x**2 * y + 180 * x**2 * z - 240 * x**2 - 120 * x * y - 60 * x * z + 60 * x,
                    180 * x**2 * y - 60 * x * y,
                ],
                [
                    270 * x**2 * y + 180 * x * y**2 + 180 * x * y * z - 240 * x * y - 30 * y**2 - 30 * y * z + 30 * y,
                    -270 * x**3 - 180 * x**2 * y - 270 * x**2 * z + 360 * x**2 + 60 * x * y + 90 * x * z - 90 * x,
                    90 * x**2 * y - 30 * x * y,
                ],
                [
                    -180 * x * y**2 + 60 * x * y - 270 * y**3 - 270 * y**2 * z + 360 * y**2 + 90 * y * z - 90 * y,
                    180 * x**2 * y - 30 * x**2 + 270 * x * y**2 + 180 * x * y * z - 240 * x * y - 30 * x * z + 30 * x,
                    90 * x * y**2 - 30 * x * y,
                ],
                [
                    360 * x * y**2 - 120 * x * y + 180 * y**3 + 180 * y**2 * z - 240 * y**2 - 60 * y * z + 60 * y,
                    -360 * x**2 * y + 60 * x**2 - 180 * x * y**2 - 360 * x * y * z + 360 * x * y + 60 * x * z - 60 * x,
                    180 * x * y**2 - 60 * x * y,
                ],
                [
                    -360 * x * y * z - 540 * y**2 * z - 540 * y * z**2 + 540 * y * z,
                    180 * x**2 * z + 360 * x * y * z + 180 * x * z**2 - 180 * x * z,
                    180 * x**2 * y + 180 * x * y**2 + 360 * x * y * z - 180 * x * y,
                ],
                [
                    360 * x * y * z + 180 * y**2 * z + 180 * y * z**2 - 180 * y * z,
                    -540 * x**2 * z - 360 * x * y * z - 540 * x * z**2 + 540 * x * z,
                    180 * x**2 * y + 180 * x * y**2 + 360 * x * y * z - 180 * x * y,
                ],
                [
                    360 * x * y * z + 180 * y**2 * z + 180 * y * z**2 - 180 * y * z,
                    180 * x**2 * z + 360 * x * y * z + 180 * x * z**2 - 180 * x * z,
                    -540 * x**2 * y - 540 * x * y**2 - 360 * x * y * z + 540 * x * y,
                ],
            ]
