    ...
    if celltype == basix.CellType.triangle:
        ...
        if n == 2:
            return [[12*x*y - 3*y, 18*x**2 - 9*x],
                    ...
                    [12*x*y + 12*y**2 - 9*y, 18*x**2 + 48 *
                        x*y - 27*x + 30*y**2 - 36*y + 9],
                    [18*y**2 - 9*y, 12*x*y - 3*x + 30*y**2 - 24*y + 3],
                    [-9*x*y - 15*y**2/2 + 6*y, 3*x**2 /
                        2 - 15*x*y - 15*y**2 + 15*y - 3/2],
                    [30*x**2 + 48*x*y - 36*x + 18*y**2 -
                        27*y + 9, 12*x**2 + 12*x*y - 9*x],
                    [30*x**2 + 12*x*y - 24*x - 3*y + 3, 18*x**2 - 9*x],
                    [-15*x**2 - 15*x*y + 15*x + 3*y**2 /
                        2 - 3/2, -15*x**2/2 - 9*x*y + 6*x],
        ...
        if n == 3:
            return [
                ...
                [80*y**3 - 80*y**2 + 16*y, 60*x*y**2 - 40*x * \
                    y + 4*x + 140*y**3 - 180*y**2 + 60*y - 4],
                ...
                [140*x**3 + 60*x**2*y - 180*x**2 - 40*x*y + \
                    60*x + 4*y - 4, 80*x**3 - 80*x**2 + 16*x],
                ...
                [-120*x**2*y + 100*x*y + 80*y**3 - 80*y**2, - \
                    20*x**3 + 20*x**2 + 60*x*y**2 - 40*x*y],
                [60*x**2*y + 120*x*y**2 - 80*x*y + 40*y**3 - 60*y**2 + 20*y, 80*x**3 + 300*x**2*y - 160*x**2 + 240*x*y**2 - 300*x*y + 80*x],  # noqa: E501
                [-60*x**2*y + 40*x*y + 20*y**3 - 20*y**2, - \
                    80*x**3 + 80*x**2 + 120*x*y**2 - 100*x*y],
                [-15*x**2*y - 30*x*y**2 + 20*x*y - 5*y**2 + 5*y,
                    15*x**3 + 30*x**2*y - 20*x**2 - 10*x*y + 5*x],
                [30*x*y**2 - 10*x*y + 15*y**3 - 20*y**2 + 5*y, - \
                    30*x**2*y - 5*x**2 - 15*x*y**2 + 20*x*y + 5*x]
            ]
    if celltype == basix.CellType.tetrahedron:
        ...
        if n == 2:
            return [
                ...
                [18*z**2 - 9*z, 18*z**2 - 9*z, 12*x*z - 3 * \
                    x + 12*y*z - 3*y + 30*z**2 - 24*z + 3],
                ...
                [18*y**2 - 9*y, 12*x*y - 3*x + 30*y**2 + \
                    12*y*z - 24*y - 3*z + 3, 18*y**2 - 9*y],
                ...
                [30*x**2 + 12*x*y + 12*x*z - 24*x - 3*y - \
                    3*z + 3, 18*x**2 - 9*x, 18*x**2 - 9*x],
                ...
                [-36*y*z, -12*x*z - 48*y*z - 12*z**2 + 12 * \
                    z, -12*x*y - 12*y**2 - 48*y*z + 12*y],
                [12*y*z, 36*x*z + 48*y*z + 36*z**2 - 36 * \
                    z, 12*x*y + 12*y**2 + 24*y*z - 12*y],
                [-12*y*z, -12*x*z - 24*y*z - 12*z**2 + 12 * \
                    z, -36*x*y - 36*y**2 - 48*y*z + 36*y],
                [-48*x*z - 12*y*z - 12*z**2 + 12*z, -36 * \
                    x*z, -12*x**2 - 12*x*y - 48*x*z + 12*x],
                [48*x*z + 36*y*z + 36*z**2 - 36*z, 12*x * \
                    z, 12*x**2 + 12*x*y + 24*x*z - 12*x],
                [-24*x*z - 12*y*z - 12*z**2 + 12*z, -12 * \
                    x*z, -36*x**2 - 36*x*y - 48*x*z + 36*x],
                [-48*x*y - 12*y**2 - 12*y*z + 12*y, -12*x **
                    2 - 48*x*y - 12*x*z + 12*x, -36*x*y],
                [48*x*y + 36*y**2 + 36*y*z - 36*y, 12*x **
                    2 + 24*x*y + 12*x*z - 12*x, 12*x*y],
                [-24*x*y - 12*y**2 - 12*y*z + 12*y, -36 * \
                    x**2 - 48*x*y - 36*x*z + 36*x, -12*x*y]
            ]
