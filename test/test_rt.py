...
def sympy_rt(celltype, n):
    ...
    if celltype == basix.CellType.tetrahedron:
        ...
        if n == 3:
            return [
                [
                    252 * x**3 - 216 * x**2 + 36 * x,
                    252 * x**2 * y - 144 * x * y + 12 * y,
                    252 * x**2 * z - 144 * x * z + 12 * z,
                ],
                [
                    252 * x * y**2 - 144 * x * y + 12 * x,
                    252 * y**3 - 216 * y**2 + 36 * y,
                    252 * y**2 * z - 144 * y * z + 12 * z,
                ],
                [
                    252 * x * z**2 - 144 * x * z + 12 * x,
                    252 * y * z**2 - 144 * y * z + 12 * y,
                    252 * z**3 - 216 * z**2 + 36 * z,
                ],
                [
                    63 * x * y**2 + 252 * x * y * z - 72 * x * y + 63 * x * z**2 - 72 * x * z + 12 * x,
                    63 * y**3 + 252 * y**2 * z - 90 * y**2 + 63 * y * z**2 - 108 * y * z + 24 * y,
                    63 * y**2 * z + 252 * y * z**2 - 108 * y * z + 63 * z**3 - 90 * z**2 + 24 * z,
                ],
                [
                    63 * x**3 + 252 * x**2 * z - 90 * x**2 + 63 * x * z**2 - 108 * x * z + 24 * x,
                    63 * x**2 * y + 252 * x * y * z - 72 * x * y + 63 * y * z**2 - 72 * y * z + 12 * y,
                    63 * x**2 * z + 252 * x * z**2 - 108 * x * z + 63 * z**3 - 90 * z**2 + 24 * z,
                ],
                [
                    63 * x**3 + 252 * x**2 * y - 90 * x**2 + 63 * x * y**2 - 108 * x * y + 24 * x,
                    63 * x**2 * y + 252 * x * y**2 - 108 * x * y + 63 * y**3 - 90 * y**2 + 24 * y,
                    63 * x**2 * z + 252 * x * y * z - 72 * x * z + 63 * y**2 * z - 72 * y * z + 12 * z,
                ],
                [
                    -252 * x**3
                    - 504 * x**2 * y
                ...
                [
                    -252 * x * y**2 + 144 * x * y - 12 * x + 180 * y**2 - 120 * y + 12,
                    -252 * y**3 + 216 * y**2 - 36 * y,
                    -252 * y**2 * z + 144 * y * z - 12 * z,
                ],
                [
                    -252 * x * z**2 + 144 * x * z - 12 * x + 180 * z**2 - 120 * z + 12,
                    -252 * y * z**2 + 144 * y * z - 12 * y,
                    -252 * z**3 + 216 * z**2 - 36 * z,
                ],
                [
                ...
                [
                    252 * x**3 - 216 * x**2 + 36 * x,
                    252 * x**2 * y - 180 * x**2 - 144 * x * y + 120 * x + 12 * y - 12,
                    252 * x**2 * z - 144 * x * z + 12 * z,
                ],
                [
                    252 * x * z**2 - 144 * x * z + 12 * x,
                    252 * y * z**2 - 144 * y * z + 12 * y - 180 * z**2 + 120 * z - 12,
                    252 * z**3 - 216 * z**2 + 36 * z,
                ],
                [
                    63 * x**3 + 252 * x**2 * z - 90 * x**2 + 63 * x * z**2 - 108 * x * z + 24 * x,
                ...
                [
                    -252 * x**3 + 216 * x**2 - 36 * x,
                    -252 * x**2 * y + 144 * x * y - 12 * y,
                    -252 * x**2 * z + 180 * x**2 + 144 * x * z - 120 * x - 12 * z + 12,
                ],
                [
                    -252 * x * y**2 + 144 * x * y - 12 * x,
                    -252 * y**3 + 216 * y**2 - 36 * y,
                    -252 * y**2 * z + 180 * y**2 + 144 * y * z - 120 * y - 12 * z + 12,
                ],
                [
                    -63 * x**3 - 252 * x**2 * y + 90 * x**2 - 63 * x * y**2 + 108 * x * y - 24 * x,
                    -63 * x**2 * y - 252 * x * y**2 + 108 * x * y - 63 * y**3 + 90 * y**2 - 24 * y,
